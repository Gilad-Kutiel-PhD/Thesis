...
In a typical instance of a \emph{network design} problem we are given a collection of resources and our goal is to construct a desired network that satisfies some requirements while consuming utilizing the minimum possible amount of resources.
One of the classical network design problems, and maybe the most well known, is the Minimum Spanning Tree problem, where given an undirected weighted graph our goal is to find the minimum cost set of edges that induces a connected graph.
