In this thesis we develop and analyze approximation algorithms for four NP-hard combinatorial optimization problems.
The first two problems, namely the \textsc{Convex Recoloring} and the \textsc{Service Chain Placement in SDNs} are network design problems.
The third problem deals with the maximization of a general monotone submodular function.
Lastly, we consider the \textsc{Maximum Carpool Matching} problem and show how this problem can be formulated as a submodular function optimization problem.
