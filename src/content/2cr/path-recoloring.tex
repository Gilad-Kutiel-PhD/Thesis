...
\centering
\add{fig-retains-all}
\caption[Convex Recoloring - Example of retains-all and non-retains-all (optimal) convex recolorings]{
...
Later in the thesis we will introduce a simple algorithm that computes a path-recoloring. 
} 
in $G_{\chi'}[c]$: 
