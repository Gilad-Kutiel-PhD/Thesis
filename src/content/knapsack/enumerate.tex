In \cite{khuller1999budgeted} it is shown that by enumerating all the triplets over the 
...
\todo{
Make sure the number of density buckets is constant and does not depend on n, 
for example if there is an exponential difference between the smallest density and the largest. 
} 
